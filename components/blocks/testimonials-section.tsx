    ...
    testimonials = [
      {
        ...
        logo: "/images/phynacare-logo.png",
      },
      {
        company: "Doze",
            ...
            >
              <div className="flex justify-center mb-6">
                {testimonial.company === "Phynacare" ? (
                  <div className="w-24 h-24 rounded-full overflow-hidden flex items-center justify-center border-2 border-[#cfaa5c]">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/phyphy-tC8N2yeReov7uyxMqT7c9WUiOaJ6N0.webp"
                  ...
                  <div className="w-32 h-24 rounded-lg overflow-hidden flex items-center justify-center border-2 border-[#cfaa5c] bg-black p-2">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Capture%20d%E2%80%99e%CC%81cran%202025-04-08%20a%CC%80%2006.27.39.jpg-0qnXJStu9ANIevkVt4RY4YNSlavNw1.jpeg"
                      alt={`${testimonial.company} logo`}
                  ...
                  <div className="w-24 h-24 rounded-full overflow-hidden flex items-center justify-center border-2 border-[#cfaa5c] bg-white p-2">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/phyphy%20%281%29-MEiBERtQFOzjiozG9yzUxSGjFLYYtA.webp"
                      alt={`${testimonial.company} logo`}
                      className="w-full h-auto object-contain"
                    />
                  </div>
